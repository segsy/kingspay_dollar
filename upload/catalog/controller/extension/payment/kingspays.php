...
class ControllerExtensionPaymentKingspays extends Controller {
    public function index() {
      ...
      $payment = ($order_info['currency_code'] == 'USD') ? 'USD' : 'international';
      ...
      $config = array (
        ...
        'device_signature'       => $order_info['device_signature'],
    ...
    public function send()
    {
      ...
      $payment = ($order_info['currency_code'] == 'USD') ? 'USA' : 'international';
      $ip_address = $order_info($_SERVER['SERVER_ADD']);
      $device_signature = $order_info($_SERVER['HTTP_USER_AGENT']);
